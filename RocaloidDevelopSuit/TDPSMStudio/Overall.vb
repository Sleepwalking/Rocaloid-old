...
Public Module OverAll
	...
	Public CurrentSymbol As String
	Public CurrentPitch As String
	Public CurrentBasePeriod As Integer
	Public Delegate Sub LoadFinishCallBack(ByVal FileName As String)
	...
	Public Function GetFreqByPitch(ByVal Pitch As String) As Double
		...
		Return 0
	End Function
	Public Function GetNumByPitch(ByVal Pitch As String) As Integer
		Dim i As Integer
		For i = 0 To PitchListQ
			If Pitch = PitchList(i) Then
				Return i
