...
Friend Class MixerWriterEffector
	...
	Public Shared Overloads Sub Write(ByVal _Short As Short)
		...
		End Try
	End Sub
	Public Shared Overloads Sub Write(ByRef Wave As WaveBuffer, ByVal Start As Integer, ByVal Dest As Integer)
		Dim i As Integer
		...
		End If
	End Sub
	Public Shared Sub MixAndWrite(ByRef Wave1 As WaveBuffer, ByRef Wave2 As WaveBuffer, _
