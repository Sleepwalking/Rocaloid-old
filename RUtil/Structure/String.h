...
extern void String_Join(String* Dest, String* Src);
extern void String_JoinChars(String* Dest, const char* Src);

extern int String_Equal(String* Str1, String* Str2);
extern int String_EqualChars(String* Str1, const char* Str2);
...
extern void Mid(String* Dest, String* Src, int From, int Count);
extern void MidFrom(String* Dest, String* Src, int From);
extern void Right(String* Dest, String* Src, int Count);
extern void Left(String* Dest, String* Src, int Count);

extern void UpperCase(String* Dest, String* Src);
extern void LowerCase(String* Dest, String* Src);
...
extern void Trim(String* Dest, String* Src);
extern void LTrim(String* Dest, String* Src);
extern void RTrim(String* Dest, String* Src);
